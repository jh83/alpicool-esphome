...
Based on the reverse-engineered protocol from [Gruni22/alpicool_ha_ble](https://github.com/Gruni22/alpicool_ha_ble).
...
- **Temperature range**: −20 °C to +20 °C, 1 °C steps
